...
export class LoreScene3 extends SubScene{
    ...
    constructor(scene: Phaser.Scene) {
        ...
        this.text = new Text(scene, -1920/2, 1080/2 + 200, "STOPP!", {
    ...
    subIntro(delta: number): void {
        this.moveSin(-500, 960, delta, this.blue);
    }

    subOutro(delta: number): void {
        this.moveSin(960, 1600, delta, this.blue);
        this.tbs.setAlpha(0);
