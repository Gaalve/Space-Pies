...
const config: GameConfig = {
    ...
    scene: [Background, StartScene, MainScene,  GuiScene, ShopSceneP1, ShopSceneP2, chooseSceneP1,ChooseTypeSceneP2, ChooseTypeSceneP1,chooseSceneP2, PauseScene, ChooseZoneSceneP1, ChooseZoneSceneP2],
    physics: {
        default: 'arcade'
    },
};
